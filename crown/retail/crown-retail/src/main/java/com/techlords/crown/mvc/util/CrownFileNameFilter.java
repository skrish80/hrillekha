...
/**
 * I cannot extend javax.swing.filechooser.FileNameExtensionFilter; so
 * redefining it HEHE
 * 
 * @author gv
 * 
 */
public final class CrownFileNameFilter implements FileFilter {
	 ...
	 * @see #accept
	 */
	public CrownFileNameFilter(String description, String... extensions) {
